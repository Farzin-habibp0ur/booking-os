...
export const aestheticPack: VerticalPackDefinition = {
  ...
  // medicalFormRequired retained as a vertical config flag for clinic intake forms,
  // but the AftercareProtocol model has been removed (non-PHI launch — see Phase 2).
