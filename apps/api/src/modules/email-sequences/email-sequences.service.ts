    ...
    steps: [
      {
        step: 1,
        delayHours: 0,
        subject: 'Welcome to Business Command Centre!',
        headline: 'Welcome aboard!',
        body: "Thanks for signing up. We're excited to help your clinic respond faster and prove recovered revenue. Let's get your workspace set up.",
      ...
      },
      {
        ...
        body: 'The fastest way to see Business Command Centre in action is to create your first service. It takes under 2 minutes and unlocks your online booking page.',
      ...
      },
      {
        ...
        body: 'Manage client conversations from one inbox. Connect WhatsApp and keep AI-drafted replies in staff approval mode while you test the workflow.',
      ...
      },
      {
        ...
        body: "You've been on Business Command Centre for a week. Check your dashboard to see your progress and discover features you haven't tried yet.",
    ...
    steps: [
      {
        step: 1,
        delayHours: 24,
        subject: 'Set up AI-drafted replies',
        headline: 'Configure your AI Front Desk',
        body: 'Business Command Centre can draft responses for common customer intents. Start with staff approval so your team controls tone, consent, and accuracy.',
        ctaLabel: 'Configure AI Front Desk',
        ctaPath: '/ai',
      },
      {
        step: 2,
    ...
    steps: [
      {
        ...
        body: "The highest-leverage pilot workflows are missed leads, cancellation fills, and consult follow-ups. Here's how to evaluate them.",
      ...
      },
      {
        ...
        body: 'Start with staff-reviewed AI drafts, then compare response speed, attributed bookings, and recovered revenue against your baseline.',
        ctaLabel: 'Review AI Front Desk',
        ctaPath: '/ai',
      },
      {
        step: 3,
        delayHours: 120,
        subject: 'Prove the front desk ROI case',
        headline: 'Make the business case',
        body: 'Use captured leads, approved drafts, filled cancellations, and attributed bookings to decide whether Business Command Centre should stay in your clinic workflow.',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: 2,
        delayHours: 168,
        subject: "What's new in Business Command Centre",
        headline: 'A lot has changed',
        body: "We've improved AI Front Desk workflows, approval-mode drafts, recovered revenue reporting, and channel setup. Come back and see what's new.",
