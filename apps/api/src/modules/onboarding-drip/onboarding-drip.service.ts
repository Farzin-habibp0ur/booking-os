...
export const DRIP_EMAILS: DripEmail[] = [
  {
    ...
    body: 'You signed up — great start! The fastest way to see Business Command Centre in action is to create your first service. It takes under 2 minutes and unlocks your online booking page.',
  ...
  },
  {
    ...
    body: 'Most of your clients already use WhatsApp. Connect it to Business Command Centre and manage conversations from one inbox — no more switching between apps.',
  ...
  },
  {
    ...
    body: 'Business Command Centre can draft replies for booking requests, cancellations, and general questions. Start in staff approval mode so your team controls tone and accuracy.',
  ...
  },
  {
    ...
    body: 'No-shows cost clinics thousands per year. Business Command Centre can send reminders before each appointment once your notification settings are configured.',
  ...
  },
  {
    ...
    body: "You've been on Business Command Centre for a week now. Check your dashboard to see how many bookings you've received, your busiest times, and where your clients are coming from.",
  ...
  },
  {
    ...
    subject: 'Your AI Front Desk opportunities',
    headline: 'Review front desk opportunities',
    body: 'While your team focuses on clients, the AI Front Desk can surface waitlist matches, cancellation fills, and consult follow-ups for staff approval.',
    ctaLabel: 'View AI Front Desk',
    ctaPath: '/ai',
  },
  {
    step: 11,
