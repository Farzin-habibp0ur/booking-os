    ...
    <div className="p-6">
      ...
      {staffList.length === 0 ? (
        <EmptyState
          ...
          description="Invite staff members to help manage bookings and serve customers."
          action={{ label: 'Invite Team Members', onClick: () => setShowForm(true) }}
        />
      ) : (
