            ...
            <div className="bg-white rounded-2xl shadow-soft p-6 space-y-4">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">
                  {new Date(weeklyData.dateRange.start).toLocaleDateString()} —{' '}
                  {new Date(weeklyData.dateRange.end).toLocaleDateString()}
                </p>
              </div>
                      ...
                      [
                        {
                          ...
                          thisVal: `${weeklyData.thisWeek.noShowRate}%`,
                          lastVal: `${weeklyData.lastWeek.noShowRate}%`,
                          delta: weeklyData.weekDelta.noShowRate,
                        },
                        {
                          label: t('roi.consult_conversion'),
                          thisVal: `${weeklyData.thisWeek.consultConversionRate}%`,
                          lastVal: `${weeklyData.lastWeek.consultConversionRate}%`,
                          delta: weeklyData.weekDelta.consultConversionRate,
                        },
                        {
                          label: t('roi.avg_response'),
                          thisVal: `${weeklyData.thisWeek.avgResponseMinutes}m`,
                          lastVal: `${weeklyData.lastWeek.avgResponseMinutes}m`,
                          delta: weeklyData.weekDelta.avgResponseMinutes,
                        },
                        {
                          label: t('roi.revenue'),
                          thisVal: `$${weeklyData.thisWeek.totalRevenue}`,
                          lastVal: `$${weeklyData.lastWeek.totalRevenue}`,
                          delta: weeklyData.weekDelta.totalRevenue,
                        },
                        {
                          label: t('roi.completed_bookings'),
                          thisVal: String(weeklyData.thisWeek.completedBookings),
                          lastVal: String(weeklyData.lastWeek.completedBookings),
                          delta: weeklyData.weekDelta.completedBookings,
                        },
                        {
                          label: t('roi.deposit_compliance'),
                          thisVal: `${weeklyData.thisWeek.depositCompliance}%`,
                          lastVal: `${weeklyData.lastWeek.depositCompliance}%`,
                          delta: weeklyData.weekDelta.depositCompliance,
                        },
                      ] as const
                    ).map((row) => (
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100">
                <p className="text-xs text-slate-400">
                  {t('roi.generated_at', {
                    date: new Date(weeklyData.generatedAt).toLocaleString(),
                  })}
                </p>
                <button
        ...
        <div className="mt-1">
          ...
          >
            ...
            {typeof delta === 'number'
              ...
              : delta}
            {!prefix
              ? label.includes('%') || label.includes('Rate') || label.includes('→')
                ? 'pp'
                : ''
              : ''}
          </span>
