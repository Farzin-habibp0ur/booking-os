...
| 17.13a | View AI-generated action cards proposing next steps                     | Admin     | Daily Briefing on dashboard         |
| 17.14a | Approve or dismiss AI-proposed actions                                  | Admin     | Per-card lifecycle                  |
| 17.15a | Configure per-action-type autonomy (Off / Assist / Auto)                | Admin     | Settings > AI Autonomy              |
| 17.16a | Enable/disable 5 background AI agents                                   | Admin     | Settings > Agent Skills             |
| 17.17a | Configure agent autonomy level (Suggest / Require Approval / Auto)      | Admin     | Per agent                           |
| 17.18a | View action history / audit trail of all AI + staff actions             | All staff | ActivityFeed on customer detail     |
| 17.19a | Compose outbound draft messages to customers                            | All staff | Inbox "New Message" button          |
...
| 17.16 | View AI accuracy metrics                                    | Not tracked (AgentFeedback exists but no analytics dashboard) |
