...
| Rejection Analytics | `/marketing/rejection-analytics`    | 4 Recharts visualizations (by code, by agent, trend, agent detail), weekly summary panel, filterable rejection log table with expandable rows, severity badges, pagination                                     |
