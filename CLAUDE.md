...
│   │   ├── src/
│   │   │   ├── modules/        # 72 feature modules (one dir per domain)
...
Every feature is a NestJS module in `apps/api/src/modules/` (72 modules). Each module follows this pattern:
...
- **~5,995 total tests** across 419 test files
