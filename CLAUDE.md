...
│   │   ├── src/
│   │   │   ├── modules/        # 77 feature modules (one dir per domain)
...
Every feature is a NestJS module in `apps/api/src/modules/` (77 modules). Each module follows this pattern:
...
- **~6,081 total tests** across 424 test files
