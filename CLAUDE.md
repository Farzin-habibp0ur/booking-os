...
│   │   ├── src/
│   │   │   ├── modules/        # 75 feature modules (one dir per domain)
...
Every feature is a NestJS module in `apps/api/src/modules/` (75 modules). Each module follows this pattern:
...
- **~6,045 total tests** across 422 test files
