...
│   │   ├── src/
│   │   │   ├── modules/        # 79 feature modules (one dir per domain)
...
Every feature is a NestJS module in `apps/api/src/modules/` (79 modules). Each module follows this pattern:
...
- **~6,169 total tests** across 430 test files
