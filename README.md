...
| Console        | `/admin/businesses`, `/admin/view-as`, `/admin/overview`, `/admin/audit-logs`, `/admin/health`, `/admin/support-cases`, `/admin/billing`, `/admin/packs-console`, `/admin/agents-console`, `/admin/messaging-console`, `/admin/settings`, `/admin/skills-console` | Platform Console: business directory, 360 view, view-as, overview KPIs, audit log, health checks, support cases, billing operations, packs & skills registry, AI agent governance, messaging ops, platform settings (Super Admin) |
...
| ActionCard     | `/action-cards`                                                                                                                                                                                                                                                   | Action card CRUD, approve/dismiss/snooze/execute, expiry cron. Agent-created cards include `expiresAt` (48h–30d per agent type)                                                                                                   |
...
| Agent          | `/agent`                                                                                                                                                                                                                                                          | Agent framework CRUD, agent runs, scheduling, AGENT_PROCESSING queue, 5 background agents. `triggerAgent()` updates `AgentConfig.lastRunAt` after each run                                                                        |
