# Evergreen Trends Library

> Last updated: 2026-03-12
> Purpose: Fallback trend + keyword library when MCP sources are unavailable. Curated manually from validated market research.
> Referenced by: Trend Scout (P9), Content Strategist (P11)
> Update schedule: Monthly review on 1st of each month

---

## How to Use This File

1. **Trend Scout** uses this as fallback when Apify/Firecrawl MCPs are unavailable
2. **Content Strategist** cross-references this for evergreen brief ideas during slow news weeks
3. Each trend has a **Pillar**, **Funnel Stage**, and **Shelf Life** rating
4. Trends marked `PERENNIAL` can be used any time; `SEASONAL` trends have date windows

---

## Pillar 1: Booking & Scheduling
...
| Seasonal promotion strategies | TOFU | SEASONAL (Q4, Valentine's, Mother's Day) | holiday salon promotions, seasonal spa offers | Tie to campaign builder |
| Multi-location scaling | BOFU | PERENNIAL | multi-location salon software, franchise management | Advanced feature |
| Partnership marketing for local businesses | TOFU | PERENNIAL | local business partnerships, cross-promotion ideas | Low-cost growth strategy |

---

## Pillar 4: Operations & Efficiency
...
|-------|-----------|----------------------|
| January | New Year | "New year, new systems" — fresh start messaging, goal-setting |
| February | Valentine's Day | Couples packages, gift cards, romantic services |
| March | International Women's Day, Spring | Women-owned business spotlight, spring refresh |
| April | Tax season ends | "Invest in your business" — budget for tools |
| May | Mother's Day, Memorial Day | Gift card promotions, self-care messaging |
| June | Summer kickoff | Summer booking prep, staffing for busy season |
| July | Mid-year | "Mid-year business check-in" — analytics review |
| August | Back to school | Fall prep, new client acquisition season |
| September | Fall restart | "Back to business" — end-of-summer push |
| October | Halloween, Small Business Month prep | Community content, local business features |
| November | Small Business Saturday, Black Friday | Deals, promotions, campaign builder showcase |
| December | Holidays, Year-end | Year in review, holiday booking surge, gift cards |

---

## Usage Notes

- When using evergreen trends as fallback, flag output with `[CACHED]` or `[EVERGREEN]`
- Do NOT use more than 3 evergreen trends in a single briefing (risk of repetitive content)
- Cross-check against last 4 weeks of `briefings/` to avoid topic repetition
- Refresh keyword data when MCP sources come back online
...
| Date | Change |
|------|--------|
| 2026-03-12 | Initial creation — 7 topics per pillar, seasonal calendar |
